...
- **Backend tối giản**: 8 platform services (iam/platform-registry/tenant-manager/feature-flag/master-data/social-integration/workflow/approval) + 6+ applications nghiệp vụ.
...
│   │   │                     # feature-flag, master-data, social-integration, workflow, approval
...
- **Platform services tối giản** — CHỈ 8 services: iam (JWT verify only), platform-registry, tenant-manager, feature-flag, master-data, social-integration, workflow, approval.
