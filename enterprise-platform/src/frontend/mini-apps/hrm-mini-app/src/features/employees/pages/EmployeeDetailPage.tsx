...
import { Spin, Result, Button, Card, Avatar, Tag, Descriptions, Divider } from 'antd';
      ...
      <Card>
        <div style={{ display: 'flex', gap: 16, alignItems: 'center', marginBottom: 24 }}>
          <Avatar
            ...
            style={{ backgroundColor: '#2563EB', fontSize: 32 }}
          >
            {getInitials(employee.fullName)}
          </Avatar>
          <div>
            <h2 style={{ margin: 0 }}>{employee.fullName}</h2>
            <p style={{ color: 'var(--color-text-secondary)', margin: 0 }}>{employee.email}</p>
